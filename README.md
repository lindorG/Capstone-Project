...
Through the use of HTML, CSS, and JavaScript, and Adobe tools such as Photoshop, After Effects, I made sure that every page on my website is great to look it. And it's not just an eyecatcher—I put so much emphasis on user-experience which is something I care deeply about. It took trial and error to make sure every corner, button, input, or image was pleasing to look at, properly formatted, and that the animations themselves were tuned perfectly. I think my mostly amateur experience in graphic design, photography, digital art, and video editing really helped bring my concepts to life, and I am really proud of how my web app looks like.

I plan on adding a community messge board/forum where users can communicate with each other, strategize, theorycraft, ask questions, and receive/provide feedback from to other users. This area is still under construction.
