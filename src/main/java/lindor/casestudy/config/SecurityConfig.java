...
import lindor.casestudy.security.UserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http
                .csrf().disable()
                .authorizeRequests()
                .antMatchers("/pub/**", "/error/**", "/login/**", "/index", "/news", "/about", "/forum", "/user/**").permitAll()
                .antMatchers("/admin/**", "/team/**", "/search", "/pokemon/**").authenticated()
                .and()
                .formLogin()
